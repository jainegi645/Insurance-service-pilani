...
import childreneducatoion from "../images/childreneducation.png";
      ...
      <div className=" px-5 md:flex  lg:px-24 lg:mt-14 md:space-x-4">
        ...
        >
          <img
            ...
            src="https://img.icons8.com/fluency/64/000000/service.png"
          />

          <h1 className="ribbon mb-6 py-3">
            <strong className="ribbon-content text-slate-100">Get 20 Lacs for Education</strong>
          </h1>
          <p className="text-primaryColor font-bold text-xl">
            Children Education Plan
          </p>
          <p className="text-gray-600 pt-4 lg:text-xl">
            Get 20 lacks for children education Plannig just investing 189/-*
            Approx Per day
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="border-gray-500 w-full rounded-2xl px-6 py-16 lg:py-28 text-center md:shadow-2xl shadow-xl"
        >
          <img
          ...
          />
          <h1 className="ribbon mb-6 py-3">
            <strong className="ribbon-content text-slate-100
            ">Get 20 Lacs for Education</strong>
          </h1>
          <p className="text-primaryColor font-bold text-xl">
        ...
        >
          <img
            className="m-auto pb-9"
            src="https://img.icons8.com/external-parzival-1997-outline-color-parzival-1997/64/000000/external-experience-human-networking-parzival-1997-outline-color-parzival-1997.png"
          />
          <h1 className="ribbon mb-6 py-3">
            <strong className="ribbon-content text-slate-100">Get 20 Lacs for Education</strong>
          </h1>
          ...
          <p className="text-gray-600 pt-4 lg:text-xl">
            After 25 Years, 80 Lakhs Maturity. Get Total Benefit up to 7.40Cr.
...
// <h1 className="ribbon">
//   <strong className="ribbon-content">Get 20 Lacs for Education </strong>
// </h1>

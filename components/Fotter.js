  ...
  return (
    <>
      <div className=" lg:text-lg px-5 lg:px-28 lg:py-10  bg-primaryColor goBack text-white lg:flex justify-between">
        <div className="pt-20 pb-11 md:pb-0  lg:pt-0 lg:mt-16">
          ...
          <div className="flex pt-7 pb-1 lg:pt-5 lg:pb-2 space-x-3">
            <img className='w-8 h-2/4 lg:w-10 lg:h-2/4 cursor-pointer' src="https://img.icons8.com/fluency/40/000000/instagram-new.png" />
            <img className='w-8 h-2/4 lg:w-10 lg:h-2/4 cursor-pointer' src="https://img.icons8.com/fluency/40/000000/facebook.png" />
            <img className='w-8 h-2/4 lg:w-10 lg:h-2/4 cursor-pointer' src="https://img.icons8.com/color/40/000000/google-maps.png" />{" "}
          </div>
        </div>

        <div className="lg:flex-col lg:mt-16 justify-center hidden md:block">
        <p className='lg:text-2xl text-xl pb-4 tracking-wider'>Our Products</p>
    ...
    <div>
      ...
      <div className=" text-sm  px-5 lg:flex lg:justify-between  py-2 lg:px-24 bg-secondayColor text-white">

...
function WhyUs() {
  return (
    <div>
      ...
      <div className=" px-5 lg:flex lg:px-24 lg:mt-14 md:space-x-8">
        <motion.div
          whileHover={{
            y: -3,
            x: -18,
          ...
          className=" px-6 shadow-xl md:shadow-none py-24 rounded-xl  lg:py-28 text-center"
        >
        ...
        <motion.div
          ...
          className="border-gray-500 shadow-2xl rounded-2xl px-6 py-24 lg:py-28 text-center"
        >
          <img
        ...
        <motion.div
          ...
          className="px-6 py-24 shadow-xl md:shadow-none lg:py-28 text-center rounded-xl"
        >
